...
const twoBlogsDifferentAuthors = [
    {
        _id: '5a422aa71b54a676234d17f8',
        title: 'Go To Statement Considered Harmful',
        author: 'Edsger W. Dijkstra',
...
describe('most blogs', () => {
    ...
    test('two blogs, two authors', () => {
        const result = listHelper.mostBlogs(twoBlogsDifferentAuthors)
        expect(result.blogs).toBe(1)
    })
})
...
describe('most likes', () => {
    ...
    test('one blog', () => {
        ...
        expect(result.likes).toBe(oneBlog[0].likes)
        expect(result.author).toBe(oneBlog[0].author)
    })
})